// Vendored verbatim from DavidHDev/canvas-ui (MIT + Commons Clause):
// src/lib/GlyphRain/GlyphRainVanilla.ts
...
export function createGlyphRain(
  ...
  function readPageLum(): number {
    try {
      ...
      // Probe/paint failures fall back to defaults and retry next frame.
    }
    return 0;
  }
